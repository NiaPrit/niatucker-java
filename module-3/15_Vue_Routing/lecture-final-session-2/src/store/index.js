...
export default new Vuex.Store({
  state: {
    // hold the id for currently displayed product so any component can find out the active product
    activeProduct: 0,  
    filter: 0,
    products: [
      {
  ...
  strict: true  // Enforce the rule that only mutation can change data store
})
