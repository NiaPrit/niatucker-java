...
export default {
  data() {
    return {
      isLoading: true,
      showAddBoard: false,
      newBoard: {  // hold the values for a newBoard
        title: '', // two-way bound to the form field
  ...
  methods: {
    ...
    saveNewBoard() {  // Take the newBoard object and send to the service to get it added to API server
        boardsService.addBoard(this.newBoard)
        // error handling should be coded here - we didn't do it to save time
    },
