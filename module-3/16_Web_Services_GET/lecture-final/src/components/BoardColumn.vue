<template>
  <div class="board">
    <h2>{{ title }}</h2>
    <div class="cards">
      <!-- generated for each card in the cards                                              -->
...
export default {
  name: 'board-column',
  // props are attribute that come from outside this component
  ...
  methods: {
    viewCardDetails(cardID) {
      // tell Vue Router to go to the path '/board/:boardID/card/:cardID'
